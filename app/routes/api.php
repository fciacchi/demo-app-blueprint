...
app()->get(
    '/api/employees/{employee_id}/payment-method/{id}',
    static function ($employee_id, $id): void {
        $controller = new PaymentMethodController();
...
app()->get(
    ...
    static function ($fundraiser_id): void {
        ...
        $controller->index($fundraiser_id, $page);
    }
);
...
app()->get(
    '/api/fundraisers/{fundraiser_id}/missions/{id}',
    static function ($fundraiser_id, $id): void {
        $controller = new MissionController();
...
app()->get(
    ...
    static function ($fundraiser_id, $mission_id): void {
        ...
        $controller->index($fundraiser_id, $mission_id, $page);
    }
);
